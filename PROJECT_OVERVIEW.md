...
- ✅ `src/resist_threshold.py`, `src/metrics.py` — Phase 5 MVP threshold resist + CD/EPE metrics
- ⏳ `src/` (Phase 2–6) — `illuminator.py`, `mask_3d.py`, `resist_blur.py`, `resist_depth.py`, `resist_stochastic.py`, `smo.py`, `pmwo.py`
...
- ✅ `tests/phase5_threshold.py`, `tests/integration_end_to_end.py` — threshold resist + end-to-end MVP tests
- ⏳ `tests/` (Phase 2–6) — 후속 정밀화 단위 테스트
- ✅ `notebooks/0_first_aerial_image.ipynb` — Phase 1 데모
- ✅ `notebooks/4a_threshold_resist.ipynb` — Phase 5 MVP threshold resist 데모
...
- ✅ `docs/phase5_resist_models.md` — Threshold resist MVP + 한계 기록
