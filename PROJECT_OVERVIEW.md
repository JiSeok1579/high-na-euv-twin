...
- ✅ `src/resist_threshold.py`, `src/resist_blur.py`, `src/resist_depth.py`, `src/resist_stochastic.py`, `src/metrics.py` — Phase 5 완료: threshold + Gaussian blur + depth/profile + stochastic CD/LWR/LCDU/convergence/calibration metrics
...
- ✅ `notebooks/4a_threshold_resist.ipynb`, `notebooks/4b_resist_levels.ipynb` — Phase 5 threshold/blur/depth/profile/stochastic/convergence/calibration 데모
...
### Step 2 — Phase 4 M3D 6 effects stub
- paper #12의 6개 mask 3D 효과를 테스트 명세로 변환
...
자산 (현재):
  ...
  ✅ 시뮬레이터 코드 Phase 1/3/5 구현
  ⏳ Open Access PDF 다운로드 (사용자 수동)

다음 단계:
  1. Phase 4 M3D 6 effects stub
