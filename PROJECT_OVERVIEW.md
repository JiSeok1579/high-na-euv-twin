...
- ✅ `src/resist_threshold.py`, `src/resist_blur.py`, `src/resist_depth.py`, `src/metrics.py` — Phase 5 MVP/L1/L2 threshold + Gaussian blur + depth dose/profile + CD/EPE/LWR/SWA proxy metrics
...
- ✅ `notebooks/4a_threshold_resist.ipynb`, `notebooks/4b_resist_levels.ipynb` — Phase 5 threshold/blur/depth/profile 데모
