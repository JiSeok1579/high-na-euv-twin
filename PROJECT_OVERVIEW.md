...
- ✅ `src/resist_threshold.py`, `src/resist_blur.py`, `src/metrics.py` — Phase 5 MVP/L1 threshold + Gaussian blur + CD/EPE/LWR proxy metrics
...
- ✅ `notebooks/4a_threshold_resist.ipynb`, `notebooks/4b_resist_levels.ipynb` — Phase 5 threshold/blur/sweep 데모
