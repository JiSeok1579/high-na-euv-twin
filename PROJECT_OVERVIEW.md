...
- ✅ `src/mask_3d.py` — Phase 4 Part 03: paper #12 six-effect Mask 3D stub, boundary-corrected complex fields, absorber provenance, and lookup-table hooks
...
- ✅ `tests/phase4_m3d_6effects.py` — Phase 4 paper #12 six-effect, field boundary-correction, absorber JSON, and lookup-table tests
...
- Add field-level aerial-image regression once rigorous rows are available.
...
다음 단계:
  1. Phase 4 rigorous Mask 3D data import and aerial-image regression
